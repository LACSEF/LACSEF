A clear, concise abstract is the first impression your project makes. Judges read hundreds of these, so a strong abstract pays off.

## The 250-Word Structure

A great abstract hits four points in this order:

1. **Question** — What did you investigate? (1-2 sentences)
2. **Method** — How did you investigate it? (2-3 sentences)
3. **Results** — What did you find? (3-4 sentences)
4. **Conclusion** — Why does it matter? (1-2 sentences)
